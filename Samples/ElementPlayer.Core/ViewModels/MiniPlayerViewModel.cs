...
namespace ElementPlayer.Core.ViewModels
{
    public class MiniPlayerViewModel : BaseViewModel
    {
        ...
        public MiniPlayerViewModel(ILoggerFactory logProvider, IMvxNavigationService navigationService, IMediaManager mediaManager) : base(logProvider, navigationService)
        {
